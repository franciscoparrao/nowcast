...
does not improve discrimination. The area under the ROC curve stays near random
(AUC $\approx 0.48$): at 5\,km daily resolution the gridded rainfall at event
cell-months is no higher than average. These results suggest that the bottleneck
